...
import com.rchyn.lunchtray.ui.order.AccompanimentMenuFragment
import com.rchyn.lunchtray.ui.order.EntreeMenuFragment
import com.rchyn.lunchtray.ui.order.SideMenuFragment
...
class MenuContentTests: BaseTest() {
    ...
    fun `side_menu_item_content`() {
        ...
        onView(withId(R.id.potatoes_description))
            .check(matches(withText(containsString("Marble potatoes"))))
        onView(withId(R.id.potatoes_price))
    ...
    fun `accompaniment_menu_item_content`() {
        ...
        launchFragmentInContainer<AccompanimentMenuFragment>(themeResId = R.style.Theme_LaunchTray)
